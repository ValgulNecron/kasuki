...
use crate::register::command_struct::common::Choice;
use crate::register::command_struct::{command, common, subcommand, subcommand_group};
use crate::register::registration_function::register_command::get_commands;
use crate::register::registration_function::register_subcommand::get_subcommands;
use crate::register::registration_function::register_subcommand_group::get_subcommands_group;
