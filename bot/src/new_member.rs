...
pub fn get_channel_id(
	guild_settings: &NewMemberSetting, partial_guild: &PartialGuild,
) -> Option<ChannelId> {
...
pub async fn send_image(
	channel_id: ChannelId, image_bytes: Vec<u8>, http: &Arc<Http>,
) -> Result<()> {
...
pub async fn overlay_image(
	background_image: &mut DynamicImage, foreground_image: DynamicImage,
...
pub async fn add_text(
	image: &mut DynamicImage, text: String, x_alignment: XAlignment, y_alignment: YAlignment,
	offset: u32,
) -> Result<DynamicImage> {
