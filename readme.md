...
- Anime submodule:
    ...
    - [ ] Add caching to all request. - In Progress, Added caching for random. New top priority. (also thinking to add
      with the ai module to add an auto-translate for description and tag)
