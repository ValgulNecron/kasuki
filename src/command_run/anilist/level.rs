...
use crate::anilist_struct::run::user::{get_banner, get_color, get_completed, get_user_url, UserWrapper};
...
pub async fn send_embed(
    ...
    let xp = (2.0 * (manga_completed+anime_completed) as f64) + chap_read as f64 + (tw as f64 * 0.1);
