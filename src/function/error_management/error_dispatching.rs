...
use crate::function::error_management::no_lang_error::{error_cant_read_langage_file, error_langage_file_not_found, error_no_langage_guild_id, error_parsing_langage_json};

pub async fn error_dispatching(error: AppError, ctx: &Context, command: &ApplicationCommandInteraction) {
    match error {
